package com.example.appifylabtestbackend1.auth.serviceImpl;
...
import com.example.appifylabtestbackend1.auth.event.PasswordResetOtpEvent;
import com.example.appifylabtestbackend1.auth.model.enitty.OtpRateLimitEntity;
import com.example.appifylabtestbackend1.auth.model.enitty.PasswordResetOtpEntity;
import com.example.appifylabtestbackend1.auth.model.enitty.UserEntity;
import com.example.appifylabtestbackend1.auth.model.mapper.OtpMapper;
import com.example.appifylabtestbackend1.auth.model.mapper.OtpRateLimitMapper;
import com.example.appifylabtestbackend1.auth.repository.OtpRateLimitRepository;
import com.example.appifylabtestbackend1.auth.repository.OtpRepository;
import com.example.appifylabtestbackend1.auth.repository.UserRepository;
import com.example.appifylabtestbackend1.auth.service.PasswordResetService;
import com.example.appifylabtestbackend1.auth.util.OtpGenerator;
